...
import { getColorTemplate } from '@/utils/constant/locator-color-templates';
...
export const RECIPES = [
    {
        ...
        // The same map the sidebar's Dark theme card applies, so the two can
        // never drift apart. See utils/constant/locator-color-templates.js.
        changes: getColorTemplate('theme-dark').changes,
    },
    {
        id: 'theme-light',
        label: 'Light theme',
        ...
        changes: getColorTemplate('theme-light').changes,
    },
];
